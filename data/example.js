		...
		items: [
			{
				...
				epub: "data/books/dana_two-years-before-mast.epub",
			...
			},
			{
				...
				epub: "data/books/jerome_three-men-in-a-boat.epub",
			...
			},
			{
				...
				epub: "data/books/london_call-of-the-wild.epub",
			...
			},
			{
				...
				epub: "data/books/melville_moby-dick.epub",
			...
			},
			{
				...
				epub: "data/books/demille_a-strange-manuscript.epub",
				quote: "A fantastical tale of a lost traveller stumbling onto a hidden land.  Action, adventure and romance."
			}
		]
	},//first shelf
	{
		...
		items: [
			{
				...
				epub: "data/books/dumas_count-monte-cristo.epub",
			...
			},
			{
				...
				epub: "data/books/clavell_tai-pan.epub",
			...
			},
			{
				...
				epub: "data/books/rizal_el-filibusterismo.epub",
				quote: "The spanish upper-class of the Philippines is fat and greedy.  They don't have much longer before someone takes them out."
			}
		]
	},//second shelf
	{
		...
		items: [
			{
				...
				epub: "data/books/wilde_a-picture-of-dorian-grey.epub",
			...
			},
			{
				...
				epub: "data/books/clavell_king-rat.epub",
			...
			},
			{
				...
				epub: "data/books/dostoevsky_karamazov.epub",
	...
	},//third shelf
	{
		...
		items: [
			...
			},
			{
				...
				epub: "data/books/wilde_being-earnest.epub",
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				epub: "data/books/hemmings_the-descendants.epub",
	...
	},//sixth shelf
	{
		...
		items: [
			...
			},
			{
				...
				epub: "data/books/fallis_best-laid-plans.epub",
				quote: "Canadian political satire.  I think Fallis WISHES Canadian politics was like this.  It was ok."
			},
		]
	},//seventh shelf
]//end shelves
